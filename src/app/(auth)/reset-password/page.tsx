...
export const metadata: Metadata = {
  title: 'Restablecer contraseña | NexusLMS',
  description: 'Creá una nueva contraseña para tu cuenta NexusLMS.',
  openGraph: {
    title: 'Restablecer contraseña | NexusLMS',
    description: 'Creá una nueva contraseña para tu cuenta NexusLMS.',
    type: 'website',
...
export default async function ResetPasswordPage({ searchParams }: PageProps) {
  ...
  const token = typeof params.token === 'string' && params.token.trim() ? params.token : ''
    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-100 space-y-6">
          <div>
            <h1 className="text-nexus-text text-2xl font-bold">Restablecer contraseña</h1>
            <p className="text-nexus-muted mt-1 text-sm">Ingresá tu nueva contraseña</p>
          </div>
